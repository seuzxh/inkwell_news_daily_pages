#!/usr/bin/env python3
"""获取 InkWell 过去24小时的新增文章 (0701 08:00 → 0702 08:00)"""
...
def main():
    collected = []
    seen_ids = set()
    for page in range(1, 8):  # 最多 8 页 (400 篇)，足够 24h
        try:
    ...
    out_path = Path(__file__).parent / "0702_articles.json"
